    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 py-20 md:grid-cols-2 md:gap-16 md:px-16 md:py-32">
        ...
        <div className="flex flex-col gap-8 md:pr-8">
          ...
          <Link
            href="/assessment"
            className="group relative inline-flex w-fit items-center gap-3 overflow-hidden rounded-full
                       bg-gradient-to-r from-[#C28E3A] to-[#D4A047]
                       px-8 py-4 font-medium text-white
                       shadow-xl shadow-amber-900/20 transition-all duration-300
                       hover:scale-[1.02] hover:shadow-2xl hover:shadow-amber-900/30
                       active:scale-[0.98]"
          >
        ...
        <div className="group relative">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/5 shadow-2xl shadow-black/40 transition-all duration-500 group-hover:border-white/10">
            <Image
              src={imageSrc}
              alt="Couple in counselling session"
              width={600}
              height={600}
              priority
